<div id="PureChatWidget" class="purechat purechat-widget purechat-bottom purechat-bottom-right purechat-button-available purechat-attached purechat-style-classic purechat-state-inactive purechat-clickable purechat-widget-collapsed purechat-animate purechat-animate-fast purechat-animation-fadeInDownSmall" style="min-width: 74.6771px !important; width: 345px !important;">
        ...
        <div class="purechat-collapsed-outer purechat-display-block">
            <div class="purechat-widget-inner purechat-clearfix">
                ...
                <div class="purechat-widget-header">
                    <div class="purechat-menu purechat-btn-toolbar" style="">

                        <button type="button" class="purechat-start-chat purechat-btn purechat-btn-mini" title="Show Chat" data-trigger="expand">
                    ...
                    <div class="purechat-widget-title">
                        <span class="purechat-widget-title-link" data-trigger="collapsedClick" data-resourcekey="title_initial">Alcoholics Anonymous Chat</span>
                    </div>
                </div>
            </div>
        </div>
